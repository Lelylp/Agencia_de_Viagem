...
public class DetalheDaViagemController {
	...
	public static DetalheDaViagemController getInstance() {
	 ...
	 public DetalheDaViagem alterarDetalheDaViagem(DetalheDaViagem objDDViagem) throws DetalhesValidationException {
		    DetalheDaViagem consultaSeJaExiste = (DetalheDaViagem) this.consultaSeJaExiste(objDDViagem);
	 ...
	 public List<DetalheDaViagem> consultarDetalhes(Integer id) throws DetalhesValidationException {
		    List<DetalheDaViagem> detalheDaViagens = repositorio.consultar(new DetalheDaViagem(id));
		    if (detalheDaViagens.size() > 0 && detalheDaViagens.get(0) != null) {
		        return detalheDaViagens;
		    } else {
		        throw new DetalhesValidationException("Nenhum detalhe encontrado para " + id);
		    }
		}
 }
